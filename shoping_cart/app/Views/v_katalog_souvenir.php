...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#">Toko Souvenir</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <form action="<?= site_url('logout') ?>" method="POST" id="logout-form">
                    ...
                    <div class="col-md-3 mb-4"> <!-- Menggunakan col-md-3 untuk 4 kolom -->
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <form action="<?= site_url('souvenir/addToCart') ?>" method="post">
                                    <input type="hidden" name="idsouvenir" value="<?= $souvenir['idsouvenir'] ?>">
